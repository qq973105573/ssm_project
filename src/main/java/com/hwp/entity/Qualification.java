...
public class Qualification {
    ...
    //将查询需要返回的信息 进行额外属性封装   vo思想  value object
    //额外添加属性也会自动生成sql中对应的字段进行查询  需要忽略该属性
    @Transient    //生成sql忽略生成该字段
    private String uploadUserName;//申请人
    @Transient
